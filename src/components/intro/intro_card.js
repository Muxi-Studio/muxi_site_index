    ...
    render(props,{}){
        ...
        if(props.info.position === "组长"){
           positionColor="rgb(253, 172, 31)";
            ...
            positionColor="linear-gradient(to right, rgb(29,99,158), rgb(57,179,161))";
        }
        return(
        <div className = "intro-card-father">
        <div className ="intro-card">
            <div className = "intro-photo" style = {{backgroundImage:`url(${props.info.photo})`}}></div>
            <div className = "intro-position" style={{background:positionColor }}>{props.info.position}</div>
